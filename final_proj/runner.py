...
ROOT = '/Users/anand/Desktop/hacks'
...
def parse2(url):
    ...
    with open('/Users/anand/Desktop/hacks/devJAMS/material/reviews_crawler.py', 'w') as new_file:
        with open('/Users/anand/Desktop/hacks/devJAMS/material/review_crawler2.py') as old_file:
    ...
    os.system("scrapy runspider /Users/anand/Desktop/hacks/devJAMS/material/reviews_crawler.py -o /Users/anand/Desktop/devJAMS/material/reviews4.csv")
    data = pd.read_csv('/Users/anand/Desktop/hacks/devJAMS/material/reviews4.csv')
    rating = []
    review = []
    print('\n\n\n\n\n\n')
